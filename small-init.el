...
(my-load-file "~/.emacs.d/lisp/editing/my-xah.el")
...
(my-load-file "~/.emacs.d/lisp/editing/my-deleting.el")
(my-load-file "~/.emacs.d/lisp/editing/my-indent.el")
(my-load-file "~/.emacs.d/lisp/editing/my-search.el")
(my-load-file "~/.emacs.d/lisp/editing/my-drag.el")
...
(my-load-file "~/.emacs.d/lisp/editing/my-avy.el")
(my-load-file "~/.emacs.d/lisp/misc/my-helm.el")

;; the most minimal way to organize compile file inside Emacs
(define-key xah-fly-command-map (kbd "SPC , c") 'compile)
