...
(defun my-sp--org-mathp (_id _action _context)
  "Return t if point is inside `org-mode' math formul, nil otherwise."
...
(sp-with-modes 'org-mode
  ...
  (sp-local-pair "~" "~" :unless '(sp-point-after-word-p my-sp--org-mathp) :post-handlers '(("[d1]" "SPC")))
  (sp-local-pair "=" "=" :unless '(sp-point-after-word-p my-sp--org-mathp) :post-handlers '(("[d1]" "SPC")))
  (sp-local-pair "$" "$")
  (sp-local-pair "«" "»"))

(provide 'my-smartparens-org)
;;; my-smartparens-org.el ends here
