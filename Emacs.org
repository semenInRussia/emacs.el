...
** Transpose
   I am use [[https://github.com/rejeep/drag-stuff.el][drag-stuff]].  For example I am press =SPC TAB o=, then
   current word will moved to right, but again press this hard key
   sequence is hard, so I am press just =o=, and current word again
   moved to right, next time I am press =i= and now line moved to up.
