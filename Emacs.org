...
* Support of Special Major Modes
** Variables
   Variable =disable-xah-fly-keys-mode-hooks= is list of =major-mode=
hooks which need to disable =xah-fly-keys=:
